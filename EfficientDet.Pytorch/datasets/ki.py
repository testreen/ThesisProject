...
class KiDataset(data.Dataset):
    ...
    def __init__(self, root="", transform=None, set_name='train'):
        ...
        # Total size 395
        if set_name == 'train':
            self.image_set = images[:256] # 57*16 images
            self.target_set = target[:256]  # [[[xmin, ymin, xmax, ymax, label_ind], ... ], [[xmin, ymin, xmax, ymax, label_ind], ... ]]
        elif set_name == 'val':
            self.image_set = images[256:320] # 57*16 images
            self.target_set = target[256:320]  # [[[xmin, ymin, xmax, ymax, label_ind], ... ], [[xmin, ymin, xmax, ymax, label_ind], ... ]]
        elif set_name == 'test':
