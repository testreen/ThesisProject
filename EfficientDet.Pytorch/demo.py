...
parser.add_argument('--image_size', default=2000, type=int,
...
if __name__ == '__main__':
    detect = Detect(weights=args.weight, size_image=(args.size_image, args.size_image), num_class=args.num_class)
